...
public class AccessControlTest {
	...
	public void ValidateAnnouncements() throws InterruptedException {
		...
		acessContolPage = adminAnnouncementSummary.getAccessContol();
		acessContolPage.getAccessControlDetails(columnName, title);
		acessContolPage.configureCountyWorker();
}
	@AfterMethod
